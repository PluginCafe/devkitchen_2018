...
Bool RegisterRuledMesh()
{
	...
	return RegisterObjectPlugin(ID_DEVKITCHEN_OBJECTDATA_RULEDMESH, registeredName, OBJECT_GENERATOR | OBJECT_INPUT, RuledMesh::Alloc, "oruledmesh", AutoBitmap("oruledmesh.tif"), 0);
}
